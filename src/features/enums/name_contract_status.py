...
Attribut : name_contract_status (Contract status of previous application)
Description : 
"""
...
class NameContractStatusEnum(str, Enum):
    """
    Valeurs de Contract status of previous application.
    ...
    def to_technique(cls, metier_value: str) -> str:
        ...
        mapping = {"Active": "active", "Completed": "completed", "Demand": "demand", "Sent proposal": "sent_proposal", "Signed": "signed"}
    ...
    def to_metier(cls, technique_value: str) -> Optional[str]:
        ...
        reverse = {"active": "Active", "completed": "Completed", "demand": "Demand", "sent_proposal": "Sent proposal", "signed": "Signed"}
