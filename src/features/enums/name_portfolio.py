...
Attribut : name_portfolio (Was the previous application for)
Description : 
"""
...
class NamePortfolioEnum(str, Enum):
    """
    Valeurs de Was the previous application for.
    ...
    def to_technique(cls, metier_value: str) -> str:
        ...
        mapping = {"Cards": "cards", "Cars": "cars", "Cash": "cash", "POS": "pos", "XNA": "xna"}
    ...
    def to_metier(cls, technique_value: str) -> Optional[str]:
        ...
        reverse = {"cards": "Cards", "cars": "Cars", "cash": "Cash", "pos": "POS", "xna": "XNA"}
